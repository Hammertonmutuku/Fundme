        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li @if(Request::is('dashboard')) class="active" @endif>
            	<a href="{{ url('dashboard') }}"><i class="fa fa-dashboard"></i> <span>{{ trans('admin.dashboard') }}</span></a>
            </li><!-- ./Links -->

             <!-- Links -->
            <li @if(Request::is('dashboard/campaigns')) class="active" @endif>
            	<a href="{{ url('dashboard/campaigns') }}"><i class="ion ion-speakerphone"></i> <span>{{ trans_choice('misc.campaigns_plural',0) }}</span></a>
            </li><!-- ./Links -->

            <!-- Links -->
            <li class="@if( Request::is('dashboard/donations') ) active @endif">
            	<a href="{{ url('dashboard/donations') }}"><i class="ion ion-cash"></i> <span>{{ trans('misc.donations') }}</span></a>
            </li><!-- ./Links -->

            <!-- Links -->
            <li @if(Request::is('dashboard/withdrawals')) class="active" @endif>
            	<a href="{{ url('dashboard/withdrawals') }}"><i class="fa fa-university"></i> <span>{{ trans('misc.withdrawals') }}</span></a>
            </li><!-- ./Links -->
