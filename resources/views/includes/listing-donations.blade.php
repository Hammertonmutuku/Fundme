<li class="media py-2">
    ...
    <div class="media-body">
      <h6 class="mt-0 mb-1">{{ $donation->fullname }} <span class="font-weight-light">{{ trans('misc.donated') }}</span> <span class="text-success">{{App\Helper::amountFormat($donation->donation)}}</span> </h6>
			@if( $donation->comment != '' )
