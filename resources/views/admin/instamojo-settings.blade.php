           ...
           <!-- Start Box Body -->
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                 ...
                 <p class="help-block"><a href="https://instamojo.com/integrations" target="_blank">https://instamojo.com/integrations</a></p>
                </div>
              </div>
            </div><!-- /.box-body -->
            ...
            <div class="box-body">
              <div class="form-group">
               ...
               <div class="box-body">
                 <div class="form-group">
                   <label class="col-sm-2 control-label">Sandbox</label>
                   <div class="col-sm-10">
                     <div class="radio">
                     <label class="padding-zero">
