      ...
      <div class="content-wrapper">
		...
		<?php endif; ?>
          ...
          <hr />
               ...
               <div class="box-body">
                 <div class="form-group">
                   <label class="col-sm-2 control-label">Mpesa Sandbox</label>
                   <div class="col-sm-10">
                     <div class="radio">
                     <label class="padding-zero">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Fundme/Script/resources/views/admin/mpesa-settings.blade.php ENDPATH**/ ?>