                                ...
                                <tr>
                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                        ...
                                        <h1 style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">
                                        	Thanks for signing in <?php echo e($title_site, false); ?>

                                                                                                                                    </h1>

                                        <!-- Intro -->
                                                                                    <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                               <a href="<?php echo e(url('verify/account',$confirmation_code), false); ?>">Click here</a> to confirm your email

                                               <?php echo e(url('verify/account',$confirmation_code), false); ?>
...
<?php /**PATH /opt/lampp/htdocs/Fundme/Script/resources/views/emails/verify.blade.php ENDPATH**/ ?>